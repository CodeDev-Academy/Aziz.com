...
export default function SignIn() {
  const {
    ...
    handleChange,
    handleSubmit
  } = useAuthForm({ email: '', password: '' }, 'signin');
          ...
          <div className={styles.imageOverlay}>
            <div className={styles.quoteContainer}>
              <div className={styles.quoteText}>
                "True luxury is when your surroundings reflect your inner peace."
              </div>
              <div className={styles.quoteAuthor}>— CozyCraft Design</div>
            </div>
          </div>
        </div>
          ...
          <div className={styles.formContainer}>
            ...
            <form className={styles.authForm} onSubmit={handleSubmit} noValidate>
              ...
              <div className={styles.forgotPassword}>
                <a href="#forgot" className={styles.forgotPasswordLink} onClick={(e) => e.preventDefault()}>
                  Forgot Password?
                </a>
              </div>
